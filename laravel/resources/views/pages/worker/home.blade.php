...
<div class="main-content">
    ...
    <div class="breadcrumb">
        ...
        <ul>
            ...
            <li class="remove-pd-xs">{{ $funcionario->jornada->segunda }}h Seg</li>
            @endif
            @if($funcionario->jornada->terca)
            <li class="remove-pd-xs">{{ $funcionario->jornada->terca }}h Ter</li>
            @endif
            @if($funcionario->jornada->quarta)
            <li class="remove-pd-xs">{{ $funcionario->jornada->quarta }}h Qua</li>
            @endif
            @if($funcionario->jornada->quinta)
            <li class="remove-pd-xs">{{ $funcionario->jornada->quinta }}h Qui</li>
            @endif
            @if($funcionario->jornada->sexta)
            <li class="remove-pd-xs">{{ $funcionario->jornada->sexta }}h Sex</li>
            @endif
            @if($funcionario->jornada->sabado)
            <li class="remove-pd-xs">{{ $funcionario->jornada->sabado }}h Sab</li>
            @endif
            @if($funcionario->jornada->domingo)
            <li class="remove-pd-xs">{{ $funcionario->jornada->domingo }}h Dom</li>
            @endif
            <li>{{ $user->name }}</li>
        </ul>
    </div>
                                            ...
                                            <div class="card-header header-elements-inline">
                                                <h6 class="card-title ul-collapse__icon--size ul-collapse__right-icon mb-0">
                                                    <a class="text-default " data-bs-toggle="collapse"
                                                       href="#accordion-item-icon-right-1" aria-expanded="true">COMUNICAR
                                                        PRESENÇA</a>
                                                </h6>
                                            </div>
                                                    ...
                                                    <div style="margin:25px 0px;">
                                                        ...
                                                        <div class="row" style="display:none" id="sendPicturePonto">
                                                            ...
                                                            <div class="col-md-8 mb-4" style="text-align: center;">
                                                                <button class="btn btn-success btn-lg"
                                                                        style="margin-top: 15px;min-width: 230px;width: 100%;">
                                                        ...
                                                        <div class="row" id="takePicture">
                                                            ...
                                                            <div class="col-md-8 mb-4" style="text-align: center;">
                                                                <button class="btn btn-primary btn-lg"
                                                                        style="margin-top: 5px;min-width: 230px;width: 100%;">
                                                                    <b>INICIAR JORNADA</b></button>
                                                            </div>
                                                            <div class="col-md-2 mb-4"></div>
                                                        </div>
                                                        ...
                                                        <div class="row" id="takePicture">
                                                            ...
                                                            <div class="col-md-8 mb-4" style="text-align: center;">
                                                                <button class="btn btn-primary btn-lg"
                                                                        style="margin-top: 5px;min-width: 230px;width: 100%;">
                                                                    <b>FINALIZAR INTERVALO</b></button>
                                                            </div>
                                                            <div class="col-md-2 mb-4"></div>
                                                        </div>
                                                        <input type="hidden" name="direction" value="1"/>
                                                                                ...
                                                                                <div class="col-md-6 mb-3">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-4 mb-3">
                                                                                            <label for="startMonth">Selecionar
                                                                                                mês</label>
                                                                                            <select class="form-control"
                                                                                                    id="startMonth"
                                                                                                    name="startMonth">
                                                                                        ...
                                                                                        <div class="col-sm-3 mb-3">
                                                                                            <label for="startYear">Selecionar
                                                                                                ano</label>
                                                                                            <select class="form-control"
                                                                                                    id="startYear"
                                                                                                    name="startYear">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12"
                                                                                    ...
                                                                                    <button type="submit"
                                                                                            ...
                                                                                            style="margin-top: 15px;min-width: 290px;">
                                                                                        <b>COMUNICAR FALTA</b></button>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </form>
