@extends('templates.company', ['notificacoes' => $notificacoes])
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                                        ...
                                                        <table class="table table-hover table-striped ">
                                                            <thead style="text-align: center;">
                                                                <tr>
                                                                    ...
                                                                    <th scope="col" style="min-width: 200px;">Progresso das
                                                                        Atividades</th>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="progress mb-3">
                                                                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                                                                                    role="progressbar"
                                                                                    style="width: {{ $funcao->porcentagem_completas }}%"
                                                                                    aria-valuenow="{{ $funcao->porcentagem_completas }}"
                                                                        ...
                                                                        <td>
                                                                            <a class="text-primary me-2"
                                                                                ...
                                                                                href="/atividades/funcao/{{ $funcao->id }}">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                @include('components.filtro')
                                <div class="tab-content" id="myIconTabContent" style="padding: 10px 0px 0px;">
                                    <div class="tab-pane fade show active" id="hoje-tarefa" role="tabpanel"
                                        aria-labelledby="hoje-tarefa-tab">
                                        <div class="col-md-12 mt-3">
                                            <div class=" text-start">
                                                <div class="">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-striped ">
                                                            <thead style="text-align: center;">
                                                                <tr>
                                                                    <th scope="col">#</th>
                                                                    <th scope="col" style="min-width: 260px;">Funcionário
                                                                    </th>
                                                                    <th scope="col" style="min-width: 200px;">Progresso das
                                                                        Atividades</th>
                                                                    <th scope="col">Atividades</th>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="progress mb-3">
                                                                                <div class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                                                                                    role="progressbar"
                                                                                    style="width: {{ $funcionario->porcentagem_completas }}%"
                                                                                    aria-valuenow="{{ $funcionario->porcentagem_completas }}"
                                                                                    aria-valuemin="0" aria-valuemax="100">
                                                                        ...
                                                                        <td>
                                                                            <a class="text-primary me-2"
                                                                                style="font-size: 23px;"
                                                                                href="/atividades/funcionario/{{ $funcionario->id }}">
                                                                                <i class="nav-icon i-Eye fw-bold"></i>
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                    ...
                                    @foreach($frequencias as $frequencia)
                                        <tr>
                                            ...
                                            <td style="padding:4px 5px 0px;">
                                                <a class="text-primary" style="font-size: 26px;"
                                                    href="/frequencia/{{ $frequencia->funcionario_id }}">
                        ...
                        <div class="row">
                            <div class="col-md-6" style="text-align:center;">
                                ...
                                <div class="" style="padding:3px 0px 0px;">
                                    <a style="margin: 0px 0px 15px;width: 50%;"
                                        class="btn btn-primary text-white btn-rounded btn-icon" href="/funcionarios">
                                        <span class="ul-btn__icon">
                    ...
                    <div class="card-body" style="background-color: #e5e7eb;padding: 1.25rem;border-radius: 10px;">
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <p>
                                    Nosso equipe está sempre à disposição para iniciar um atendimento imediato e esclarecer
                                    todas as suas dúvidas sobre a usabilidade do sistema de acompanhamento de funcionários.
                                    Uma equipe especializada e pronta para ajudar, você pode contar conosco para resolver
                                    seus problemas e garantir que sua experiência seja perfeita. Não hesite em nos contatar
                                    quando precisar, estamos aqui para você!
                                    <sunt></sunt>
                                </p>
                            </div>
                            <div class="col-md-3" style="text-align: center;padding: 25px 10px 0px;">
                                <a style="margin: 15px 0px 15px;width: 80%;"
                                    class="btn btn-primary text-white btn-rounded btn-icon" href="/suporte">
                                    <span class="ul-btn__icon">
