...
<div class="main-content">
    ...
    <div class="breadcrumb">
        <h1 class="me-2">Adicionar Usuario</h1>
        <ul>
            ...
            <div class="card text-start">
                <div class="card-body">
                    <h4 class="card-title mb-3">
                        ...
                        </span> Adicionar novo usuario
                    </h4>
                    <p class="">
                        Adicione um novo <code><b>usuario</b></code>:
                    </p>
                                    ...
                                    <form action="/usuarios/cadastrar" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group mb-3">
                                                <label for="select-funcionario">Selecione a empresa:</label>
                                            ...
                                            <div class="col-md-4 form-group mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input class="form-control" name="name" value="" required type="text" placeholder="Nome completo" aria-describedby="nome-usuario-add" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-group mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input class="form-control" name="email" value="" required type="text" placeholder="nome@email.com.br" aria-describedby="email-usuario-add" />
                                                </div>
                                            </div>
                                            <div class="col-md-4 form-group mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input class="form-control" name="password" required type="text" placeholder="" aria-describedby="senha-usuario-add" />
                                                </div>
                                            </div>
                                            <div class="col-md-2 form-group mb-3"></div>
                                        </div>
